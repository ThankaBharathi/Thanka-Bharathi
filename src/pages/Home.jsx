...
import { FaXTwitter } from "react-icons/fa6"; // better X icon
    ...
    <div className="mt-20" id="home">
      <div className="flex justify-between py-10 items-center px-5 lg:px-28 lg:flex-row flex-col-reverse">
        ...
        >
          ...
          >
            AI/ML Developer passionate about building intelligent systems, solving real-world problems with data, and creating scalable applications powered by machine learning and deep learning.
          </motion.p>
